...
fiveLetters = [
    ...
    "charm", "draft", "eager", "faith", "glint", "haste", "issue", "learn", "meant", "novel", 
    "odour", "proud", "quell", "raise", "shine", "topic", "unite", "vivid", "witty", "xerox", "yield"
]
...
eightLetters = [
    ...
    "keyboard", "language", "mountain", "operator", "platform", "question", "spectrum", "tropical", "umbrella", "vacation", "yearbook", "zeppelin"
]
